...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'email@anineg.space',
  ...
  footer:
    'Powered by <a href="https://github.com/Hi-ANINEG" target="_blank" rel="noopener noreferrer"BaKi Cloud！</a>. 该文件夹及其子目录下的所有资源仅供学习和研究使用。其旨在为学术和研究人员提供参考和资料，任何其他目的均不适用。',
  ...
  email: 'mailto:email@anineg.space',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Hi-ANINEG',
    },
  ],
